...
*/
private["_group","_waypointPosition","_numberOfWaypoints","_paramsCircle","_waypointProperties","_handle"];
_group = _this select 0;
_paramsCircle = _this select 1;
...
if(_numberOfWaypoints > 1) then
{
	...
	{
		_waypointPosition = _paramsCircle call ACS_fnc_GetRandomPositionCircle;
