...
/* ### Example ###
[GROUP,[center([1,2,3]),min range,max range, number of waypoints, waypoint end radius,[2,4,6],["true","hint 'Waypoint Script';"],"COLUMN","LIMITED","MOVE","SAFE"]]execVM "framework\maps\air\patrol_random.sqf";
*/
...
_this execFSM "framework\maps\air\patrol_random.fsm";
