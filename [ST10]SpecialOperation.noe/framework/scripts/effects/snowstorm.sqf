/* 
[] execVM "framework\scripts\effects\snowstorm.sqf"; 
*/


_alpha = .55 + random 0.12;// set the alpha of the particles
[_alpha] spawn { 
		private['_blizzardSoundCounter'];
		_blizzardSoundCounter = 0;
        ...
        while {true} do {		
	       ...
	       _pos = getposASL _obj;
			...
			{
				_blizzardSoundCounter = _blizzardSoundCounter + 1;
				if(_blizzardSoundCounter >= 205) then
				{
					playMusic "Blizzard";
					_blizzardSoundCounter = 0;
				};
