...
//[group, position, type/vehicle, dir, fly, height, speed]execVM "framework\equipment\cdf\cdf_air.sqf";
...
{		
	case "an2":
	{
		...
		if(_fly) then
		{
			_vehicle = createVehicle ["RHS_AN2", _position, [], 0, "FLY"];
		}
		else
		{
			_vehicle = "RHS_AN2" createVehicle _position;
		};
		...
		switch(side _group) do
		{
			...
			{
				//pilot
				_unit = _group createUnit["rhsgref_cdf_b_air_pilot", _position, [], 0, "NONE"];
				[_unit, "cdf_pilot_makarov", false]execVM "framework\equipment\cdf\equipment_cdf.sqf";
			...
			{
				//pilot
				_unit = _group createUnit["rhsgref_cdf_air_pilot", _position, [], 0, "NONE"];
				[_unit, "cdf_pilot_makarov", false]execVM "framework\equipment\cdf\equipment_cdf.sqf";
				_unit moveInDriver _vehicle;
				//pilot
				_unit = _group createUnit["rhsgref_cdf_air_pilot", _position, [], 0, "NONE"];
